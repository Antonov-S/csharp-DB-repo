namespace TeisterMask.DataProcessor
{
    ...
    public class Deserializer
    {
        ...
        public static string ImportProjects(TeisterMaskContext context, string xmlString)
        {
            ...
            XmlSerializer xmlSerializer = new XmlSerializer(typeof(ProjectXmlInportModel[]), new XmlRootAttribute("Projects"));

            using StringReader stringReader = new StringReader(xmlString);

            ProjectXmlInportModel[] projectDtos = (ProjectXmlInportModel[])xmlSerializer.Deserialize(stringReader);

            List<Project> projects = new List<Project>();

            foreach (ProjectXmlInportModel projectDto in projectDtos)
            {
        ...
        public static string ImportEmployees(TeisterMaskContext context, string jsonString)
        {
            ...
            var employeeDtos = JsonConvert.DeserializeObject<EmployeeJsonInputModel[]>(jsonString);
